...
export const BUILDING_CATEGORIES: BuildingCategory[] = [
  {
    ...
    buildings: [
      ...
      { type: "OilExtractor", label: "Extracteur pétrole", inPorts: 0, outPorts: 0 },
      { type: "WaterExtractor", label: "Extracteur d'eau", inPorts: 0, outPorts: 0 },
      { type: "ResourceWellExtractor", label: "Extracteur puits res.", inPorts: 0, outPorts: 1 },
    ],
  },
  {
    name: "Production",
    buildings: [
      ...
      { type: "ParticleAccelerator", label: "Accélérateur particules", inPorts: 2, outPorts: 1 },
  ...
  },
  {
    name: "Énergie",
    buildings: [
      { type: "BiomassBurner", label: "Générateur biomasse", inPorts: 1, outPorts: 0 },
      { type: "CoalGenerator", label: "Générateur charbon", inPorts: 1, outPorts: 0 },
      { type: "FuelGenerator", label: "Générateur carburant", inPorts: 0, outPorts: 0 },
      { type: "NuclearPowerPlant", label: "Centrale nucléaire", inPorts: 1, outPorts: 0 },
      { type: "GeothermalGenerator", label: "Générateur géotherm.", inPorts: 0, outPorts: 0 },
    ],
  },
  {
    name: "Stockage",
    buildings: [
      { type: "Storage", label: "Conteneur stockage", inPorts: 1, outPorts: 1 },
      { type: "IndustrialStorage", label: "Conteneur industriel", inPorts: 2, outPorts: 2 },
      { type: "FluidBuffer", label: "Réservoir fluide", inPorts: 0, outPorts: 0 },
    ],
  },
  {
    ...
    buildings: [
      ...
      { type: "ProgrammableSplitter", label: "Répartiteur program.", inPorts: 1, outPorts: 3 },
  ...
  },
  {
    name: "Transport",
    buildings: [
      { type: "TruckStation", label: "Station camion", inPorts: 1, outPorts: 1 },
      { type: "DronePort", label: "Port drone", inPorts: 1, outPorts: 1 },
      { type: "TrainStation", label: "Gare ferroviaire", inPorts: 1, outPorts: 1 },
      { type: "FreightPlatform", label: "Plateforme fret", inPorts: 1, outPorts: 1 },
      { type: "FluidFreightPlatform", label: "Plateforme fret fluide", inPorts: 0, outPorts: 0 },
    ],
  },
  {
    name: "Spécial",
    buildings: [
      { type: "AwesomeSink", label: "Broyeur AWESOME", inPorts: 1, outPorts: 0 },
    ],
  },
  {
    name: "Progression",
    buildings: [
      ...
      { type: "MAM", label: "MAM (Analyse mol.)", inPorts: 0, outPorts: 0 },
